...
w = None
def create_Carnet_d_adresses(root, *args, **kwargs):
...
class Carnet_d_adresses:
    def __init__(self, top=None):
        ...
        self.Button3.place(relx=0.33, rely=0.42, height=26, width=73)
        self.Button3.configure(activebackground="#d9d9d9")
        self.Button3.configure(text='''Supprimer''')

        self.Labelframe1 = LabelFrame(self.TNotebook1_pg1)
        self.Labelframe1.place(relx=0.02, rely=0.0, relheight=0.43, relwidth=1.3)
        ...
        self.Labelframe2.place(relx=0.02, rely=0.52, relheight=0.45
                , relwidth=1.3)
        ...
        self.TButton11.place(relx=0.79, rely=0.99, height=25, width=188)
        ...
        self.Label10.place(relx=0.05, rely=1.02, height=18, width=141)
        self.Label10.configure(activebackground="#f9f9f9")
        self.Label10.configure(text='''Aperçu de l'impression''')

        self.Canvas1 = Canvas(self.TNotebook1_pg1)
        self.Canvas1.place(relx=0.16, rely=1.13, relheight=0.77, relwidth=0.95)
        ...
        self.TButton12.place(relx=0.2, rely=0.44, height=25, width=84)
        ...
        self.TButton15.place(relx=0.84, rely=0.44, height=25, width=86)
