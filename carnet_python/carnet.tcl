...
proc vTclWindow.top37 {base} {
    ...
    vTcl::widgets::ttk::scrolledtext::CreateCmd $site_4_0.scr79 \
        -background {#d9d9d9} -height 358 -highlightcolor black -width 126 
    ...
    place $site_4_0.cpd38 \
        -in $site_4_0 -x 100 -y 30 -anchor nw -bordermode inside 
